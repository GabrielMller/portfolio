...
CMD ["mule", "-M-Danypoint.platform.gatekeeper=disabled -XX:+UseContainerSupport -XX:MaxRAMPercentage=50.0 -XX:MaxMetaspaceSize=192m -XX:ReservedCodeCacheSize=128m -Djava.security.egd=file:/dev/./urandom"]